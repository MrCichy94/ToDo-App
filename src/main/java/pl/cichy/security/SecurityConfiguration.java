...
public class SecurityConfiguration extends KeycloakWebSecurityConfigurerAdapter {
    ...
    //keycloak dostarcza nam wszystkie informacje, ale my przekazujemy je dodatkowo do mappera
    //który powiększa nam czcionkę, i dodaje nam ROLE_
    //tak przyogotowane informacje, przekazujemy springowi, żeby sobie mógł poradzić
    @Autowired
